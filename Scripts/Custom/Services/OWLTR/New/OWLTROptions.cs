...
namespace daat99
{
	public class OWLTROptionsManager
	{
		...
		public void InitOwltrOptions()
		{
			...
			AddOption(OPTIONS_ENUM.CRAFTING_BANK_HIVE, new OWLTROption("Crafting BankHive", "Enabling Crafting Bank Hive will enable the bank hive to be craftable in the tinkering menu (need custom craftables to be enabled).", false));
