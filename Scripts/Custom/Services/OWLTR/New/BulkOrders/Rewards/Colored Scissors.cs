...
namespace Server.Items
{
	...
	public class ColoredScissors : Scissors, IUsesRemaining
	{
		...
		//public new int UsesRemaining { get { return m_UsesRemaining; } set { m_UsesRemaining = value; InvalidateProperties(); } }
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1060584, this.UsesRemaining.ToString() ); // uses remaining: ~1_val~
		}
