...
{
    [CorpseName("guardian hiryu corpse")]
	public class GuardianHiryu : EvoHiryu
	{
		...
		switch ( Utility.Random( 20 ))
            {
                case 0: AddItem(new HiryuEvoEgg()); break;
            }	
          ...
          public GuardianHiryu(Serial serial)
              : base(serial)
          {
		}
