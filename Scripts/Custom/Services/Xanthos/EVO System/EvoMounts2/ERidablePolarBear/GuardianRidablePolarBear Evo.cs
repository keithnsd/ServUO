...
{
    [CorpseName("guardian ridable polarbear corpse")]
	public class GuardianRidablePolarBear : EvoRidablePolarBear
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

        [Constructable]
		public GuardianRidablePolarBear() : base( "A Guardian Ridable Polarbear" )
		{
		

		Name = "Guardian Evo Ridable Polarbear";
            Body = 0XD5;
            Hue = 0;
		...
		switch ( Utility.Random( 20 ))
            {
                case 0: AddItem(new RidablePolarBearEvoEgg()); break;
            }	
          ...
          public GuardianRidablePolarBear(Serial serial)
              : base(serial)
          {
		}
