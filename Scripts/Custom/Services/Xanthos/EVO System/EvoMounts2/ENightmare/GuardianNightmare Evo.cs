...
{
    [CorpseName("guardian nightmare corpse")]
	public class GuardianNightmare : EvoNightmare
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

        [Constructable]
		public GuardianNightmare() : base( "A Guardian Nightmare" )
		{
		

		Name = "Guardian Evo Nightmare";
            Body = 0XB3;
            Hue = 0;
		...
		switch ( Utility.Random( 20 ))
            {
                case 0: AddItem(new NightmareEvoEgg()); break;
            }	
          ...
          public GuardianNightmare(Serial serial)
              : base(serial)
          {
		}
