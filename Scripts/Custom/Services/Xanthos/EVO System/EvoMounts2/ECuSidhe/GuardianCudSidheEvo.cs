...
{
    [CorpseName("guardian cu sidhe corpse")]
	public class GuardianCuSidhe : EvoCuSidhe
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

        [Constructable]
		public GuardianCuSidhe() : base( "A Guardian CuSidhe" )
		{
		

		Name = "Guardian Evo CuSidhe";
            Body = 0X115;
            Hue = 0;
		...
		switch ( Utility.Random( 20 ))
            {
                case 0: AddItem(new CuSidheEvoEgg()); break;
            }	
          ...
          public GuardianCuSidhe(Serial serial)
              : base(serial)
          {
		}
