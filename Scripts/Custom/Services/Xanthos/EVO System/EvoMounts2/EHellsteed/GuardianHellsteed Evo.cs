...
{
    [CorpseName("guardian hellsteed corpse")]
	public class GuardianHellsteed : EvoHellsteed
	{
		public override bool AddPointsOnDamage { get { return false; } }
		public override bool AddPointsOnMelee { get { return false; } }

        [Constructable]
		public GuardianHellsteed() : base( "A Guardian Hellsteed" )
		{
		

		Name = "Guardian Evo Hellsteed";
            Body = 0X319;
            Hue = 0;
		...
		switch ( Utility.Random( 20 ))
            {
                case 0: AddItem(new HellsteedEvoEgg()); break;
            }	
          ...
          public GuardianHellsteed(Serial serial)
              : base(serial)
          {
		}
