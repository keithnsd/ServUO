...
namespace Server.Items
{
    ...
    public class CraftAttributeInfo
    {
        ...
        static CraftAttributeInfo()
        {
            ...
            shadowIron.ArmorPhysicalResist = Uber ? 3 : Utility.Random(3);
            shadowIron.ArmorFireResist = Uber ? 2 : Utility.Random(2);
            shadowIron.ArmorEnergyResist = Uber ? 7 : Utility.Random(7);
