...
namespace Server.Items
{
    public class ProspectorsTool : BaseBashing
    {
        ...
        public void Prospect(Mobile from, object toProspect)
        {
            ...
            else if (vein != defaultVein || (OWLTROptionsManager.IsEnabled(OWLTROptionsManager.OPTIONS_ENUM.DAAT99_MINING) && (bank.Vein).IsProspected)) //daat99 OWLTR - prospected sticks
            {
